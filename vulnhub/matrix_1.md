...
We can log in with the username <b>guest</b> and the password <b>k1ll0r7n</b>.  Upon doing so, trying to issue some commands shows the following output (slightly edited for formatting):
